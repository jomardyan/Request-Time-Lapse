...
This Privacy Policy describes how the browser extension **Request Time-Lapse** (the "Extension") provided by **Hayk Jomardyan** ("we", "us", or "our") handles information when used in supported browsers, including Google Chrome and Microsoft Edge.
...
- Any settings, preferences, or cached data used by the Extension are stored only in your browser's local storage (localStorage) and IndexedDB, both of which remain on your device.  
...
**Name:** Hayk Jomardyan  
**GitHub:** [https://github.com/jomardyan/Request-Time-Lapse](https://github.com/jomardyan/Request-Time-Lapse)
